...
export default function AdministrativoPage() {
  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      toast({
        title: "Sucesso!",
        description: `${convertedData.length} registros administrativos carregados com sucesso.`,
      });
      event.target.value = "";
    } catch (error) {
  ...
  const handleAguardandoAprovacaoFileUpload = async (
    ...
    try {
      ...
      toast({
        title: "Sucesso!",
        description: `${convertedData.length} registros de aguardando aprovação carregados com sucesso.`,
      });
      event.target.value = "";
    } catch (error) {
      console.error("Erro detalhado:", error);
  ...
  const handleDevolucaoFileUpload = async (
    ...
    try {
      ...
      toast({
        title: "Sucesso!",
        description: `${convertedData.length} registros de devolução carregados com sucesso.`,
      });
      event.target.value = "";
    } catch (error) {
      console.error("Erro detalhado:", error);
  ...
  const handleMovimentacaoFileUpload = async (
    ...
    try {
      ...
      toast({
        title: "Sucesso!",
        description: `${convertedData.length} registros de movimentação carregados com sucesso.`,
      });
      event.target.value = "";
    } catch (error) {
      console.error("Erro detalhado:", error);
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="aguardando-file">Aguardando Aprovação</Label>
